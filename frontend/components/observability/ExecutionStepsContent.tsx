...
interface ExecutionStepsContentProps {
  entries: TraceEntry[]
  messages: Message[]
}

/**
 * ExecutionStepsContent - Displays the execution trace of the LangGraph agent
 *
 * This component was extracted from TraceView.tsx to be reusable in draggable windows.
 * It shows the execution flow through LangGraph nodes, grouped by user messages.
 */
export function ExecutionStepsContent({ entries, messages }: ExecutionStepsContentProps) {
  if (entries.length === 0) {
    return (
